    ...
    <section>
      {loading && cart.length > 0 ? (
        ...
        <div className='container'>
          {cart.length === 0 ? (
            <div className='flex min-h-[60vh] flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-8 text-center'>
              ...
              <Link className='mt-8 rounded-xl bg-orange-500 px-6 py-3 font-semibold text-white transition hover:bg-orange-600' href='/shop'>
            ...
            <div className={`${style.wrapper} overflow-visible`}>
              <div className={style.productCart}>
                {products.map(product => {
                  return (
                    <div key={product.id} className={style.bodyCart}>
                      ...
                      <div className={style.OderCart}>
                        <div className={style.OderCartBox}>
                          <FaPlus
                            className='cursor-pointer mr-1'
                            onClick={() =>
                              AddQuantityForProduct(product, dispatch)
                            }
                            size={18}
                          />
                          ...
                          {(product.quantity ?? 1) > 1 ? (
                            <FaMinus
                              onClick={() =>
                                MinusQuantityForProduct(product, dispatch)
                              }
                              className='ml-2 cursor-pointer'
                            />
                          ) : (
                            <FaMinus className='ml-2  opacity-30' />
                          )}
                          <CgTrash
                            className='cursor-pointer ml-1'
                            onClick={() => ItemDeleteINCart(product, dispatch)}
                            size={18}
                          />
                        </div>
                        <div className='flex flex-col'>
                          <span className={style.priceItem}>
                            {' '}
                            {product.price} تومان
                          </span>
              ...
              <div className={`${style.boxCart} border border-[#dedede] pb-3`}>
                <div className='flex flex-col'>
                  <div>
                    {' '}
                    <span className='block font-bold text-[20px] text-center'>
                      جزئیات قیمت
                    </span>{' '}
                  </div>
                  <div className='flex justify-between border-b border-[#c6c6c6] pb-3 mb-3'>
                    <span>تعداد کالا</span>
                    <span>{cart.length}</span>
                  </div>
                  <div className='flex justify-between my-4 border-b border-[#c6c6c6] pb-3'>
                  ...
                  <div className='flex justify-between my-3 font-bold text-[20px]'>
                ...
                <Link className={style.btnWERZ} href='/cart/shipping'>
                  <button className='cursor-pointer'>
                    تایید و تکمیل سفارش
                  </button>
                </Link>
