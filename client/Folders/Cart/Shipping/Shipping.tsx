...
import { ChangeShoppingCart } from '@/Folders/store/features/cart'
...
export default function Shipping () {
  ...
  useEffect(() => {
    document.body.style.overflow = activeChangeAddress ? 'hidden' : 'auto'
    return () => {
  ...
  `}
    ...
    `}
      ...
      <div className='flex flex-col lg:flex-row justify-between overflow-visible gap-6'>
        <div className={style.productCart}>
          ...
          {cart.map(product => {
            return (
              <div
                key={product.id}
                className='border my-6 p-4 rounded-lg border-[#d8d8d8] bg-[#f1f1f1]'
              >
                <h3 className='font-bold mt-3 my-6'> {product.title} </h3>
                <div className=''>
                  <div className=''>
                    {product.images && (
                      <>
        ...
        <div className={`${style.boxCart} border border-[#dedede] pb-3`}>
          ...
          <button className={style.btnWERZ} onClick={handleSendOrder}>
            تایید و پرداخت
          </button>
        </div>
      </div>
