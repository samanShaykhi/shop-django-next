...
import {
  ...
  changeStatus
} from '@/Folders/store/features/ModalWishListSlice'
import {
  changeProductPreview,
  changeStatusMP
} from '@/Folders/store/features/preview'
import {
  changeStatusCompare,
  ChangeProductsCompare
} from '@/Folders/store/features/compare'
...
export default function Product ({ productItem }: ProductItemType) {
  ...
  return (
    ...
    >
      ...
      >
        <FaRegHeart
          onClick={() => {
            ...
            handleLocalStorageSave('wishlist', productItem)
          }}
        />
        <CiRead
          onClick={() => {
        ...
        <FaCodeCompare
          onClick={() => {
            dispatch(changeStatusCompare())
            handleLocalStorageSave('compareProducts', productItem)
          }}
        />
      </div>
      ...
      <div className={style.proDis}>
        <h4 className='line-clamp-2 min-h-12'>{productItem.title}</h4>
        <p className='line-clamp-2 text-sm text-gray-500 min-h-[42px]'>
          {productItem.discription}
        </p>
      </div>
      <div className={style.price}>
        <span className='ml-1'>{productItem.price.toLocaleString()}</span>
        <span className=''>
          <svg
            width='18'
            height='18'
