    ...
    <div className={style.ModalXRT}>
      ...
      >
        <div className={style.headModal}>
          <span> لیست علاقه مندی ({products.length}) </span>
            ...
            <div key={product.id} className={style.item}>
              <div className={style.disIt}>
                <div className={style.close}>
                  <IoCloseSharp onClick={() => handleDeleteProduct(product)} />
                </div>
                <div className={style.dis}>
                  {product.images && (
                    <Link className='mx-2' href={`products/${product.slug}`}>
                  ...
                  <div className={style.DTX}>
                    ...
                    <span className='text-[12px]'> {product.created_at} </span>
                  </div>
                </div>
              </div>
              <div
