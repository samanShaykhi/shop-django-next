...
import SlidersProducts from '@/features/Product/Components/ListProductSlider'
...
export default function SingleProduct ({ product }: Props) {
  ...
  const handleLocalStorageSave = () => {
    ...
    if (products.length > 0) {
      ...
      messageCustom('محصول به لیست علاقه مندی ها  اضافه شد.', 'success', 4000)
  ...
  return (
    <div className='container my-6'>
      ...
      <div>
        <h5>محصولات مشابه</h5>
        <SlidersProducts products={product.related_products} />
      </div>
    </div>
  )
}
