...
export default function Wishlist () {
  const { dispatch, products, BreadcrumbsArr, handleDeleteProduct } =
    useWhishlist()
  return (
    <div>
      <div className='bg-[#d3d3d3] py-8'>
        <div className='container'>
          <div className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
            <h1 className='text-xl font-semibold md:text-2xl lg:text-[25px]'>
              لیست علاقه‌مندی‌ها
            </h1>
      ...
      <div className='container my-4 '>
        <div className={style.Wishlist}>
          {products.length === 0 ? (
            <div className='flex min-h-[55vh] flex-col items-center justify-center   bg-white px-6 py-12 text-center'>
              <div className='mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-red-50'>
                ...
                >
                  <path d='M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09A6.02 6.02 0 0116.5 3C19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z' />
                </svg>
              </div>
              ...
              <p className='mt-3 max-w-md text-gray-500'>
                هنوز محصولی را به علاقه‌مندی‌های خود اضافه نکرده‌اید. محصولات
                مورد علاقه‌تان را ذخیره کنید تا بعداً راحت‌تر به آن‌ها دسترسی
                داشته باشید.
              </p>

              <Link
                href='/shop'
                className='mt-8 rounded-xl bg-[#2e2e2e] px-6 py-3 font-medium text-white transition hover:bg-black'
              >
                مشاهده محصولات
              </Link>
            </div>
                    ...
                    <div className={style.disIt}>
                      ...
                      <div className={style.dis}>
                        ...
                        <div className={style.DTX}>
                          ...
                          <div className='flex items-center mt-auto font-bold my-3'>
