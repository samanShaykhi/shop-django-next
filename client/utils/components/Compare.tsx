...
import style from '../module/Compare.module.css'
import { GoTrash } from 'react-icons/go'
import Image from 'next/image'
import { changeStatusCompare } from '../../features/store/features/compare'
    ...
    <div className='container'>
      ...
      >
        <div className={style.ModalBody}>
          <div
            onClick={() => dispatch(changeStatusCompare())}
            className={style.HBX}
          >
            <RiCloseLargeFill />
          </div>
            ...
            <div className={style.QWESD}>
              ...
              <div className={style.UYI}>
                {products.map(product => {
                  return (
                    <div key={product.id} className={style.IMGB}>
                      <div className={style.IMGITEM}>
                        ...
                        <h4>
                          {product.title.slice(0, 84)}
                          {product.title.length > 86 && '....'}
                        </h4>
          ...
          <div className={style.rowItems}>
            <div className={style.QWESD}>
              ...
              <div className={style.UYI}>
                {products.map(pro => {
                  return (
                    <div key={pro.id} className={style.Protitle}>
                      <p> {pro.discription} </p>
                    </div>
                  )
                })}
        ...
        <div className={style.Modalfooter}>
          <div className={style.removeAll}>
            <div onClick={handleDeleteAllProduct} className={style.RBTN}>
              <button>
                {' '}
            ...
            {products.map(product => {
              return (
                <div key={product.id} className={style.RIMG}>
                  {product.images && (
                    <Link href={`products/${product.slug}`}>
                      {product.images.map(image => {
                        return (
