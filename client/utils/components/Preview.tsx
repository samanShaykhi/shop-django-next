'use client'
import style from '../module/Preview.module.css'
import { IoCloseSharp } from 'react-icons/io5'
import { useAppDispatch, useAppSelector } from '../../features/store/hooks'
import { changeStatusMP } from '../../features/store/features/preview'
import Image from 'next/image'
import Link from 'next/link'
import { AddToCart } from '../../features/utils/cart'
import { useLockBodyScroll } from '@/hooks/useLockBodyScroll'
export default function Preview () {
  const statusModal = useAppSelector(state => state.modalPreview.status)
  const product = useAppSelector(state => state.modalPreview.product)
  const dispatch = useAppDispatch()
  useLockBodyScroll(statusModal)
  return (
          ...
          <div className={style.BodyModal}>
            <div className={style.disSec}>
              <div className={style.textDisItem}>
                <h6> {product.title} </h6>
                <p className='pl-2'>{product.discription}</p>
